...
def test_prompt_formatting_success() -> None:
    ...
    try:
        formatted = prompt_template.format(
            ...
            se_24h_peak_hour=11.5,
            ch_24h_peak_hour=16.0,
            grid_24h_amp=1.5,
            grid_12h_amp=0.8,
            grid_12h_peak_hour=8.0,
        ...
        assert "- SolarEdge Diurnal Peak Hour (East Array): 11.5:00" in formatted
        assert "- Chillicon Diurnal Peak Hour (West Array): 16.0:00" in formatted
