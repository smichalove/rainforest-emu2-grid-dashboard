...
class GridDashboard(tk.Tk):
    ...
    def __init__(self) -> None:
        ...
        self.status_label: tk.Label = tk.Label(
            self.right_header, text="Waiting for data...", font=('Helvetica', STATUS_FONT_SIZE, 'bold'), bg='black', fg='white', anchor='e'
        )
        ...
        if self.usage:
            ...
            status: str = "Solar Export" if latest_val < 0 else "Grid Import"
    ...
    def process_chunk(self, xml_data: str) -> None:
        ...
        try:
            ...
            if root.tag == 'InstantaneousDemand':
                ...
                status: str = "Solar Export" if actual_kw < 0 else "Grid Import"
